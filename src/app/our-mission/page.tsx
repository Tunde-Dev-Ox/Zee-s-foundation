  ...
  return (
    <div className="bg-white overflow-x-hidden">
      ...
      <main id="main-content">
        ...
        <section className="pt-52 pb-20 bg-gradient-to-b from-gray-50 to-white max-[768px]:pt-32">
          ...
          >
            ...
            <motion.p
              ...
              variants={fadeInUp}
            >
              Zira Childcare Foundation is committed to creating a world where every child with special needs has the support, resources, and opportunities they deserve. Our mission guides every initiative, program, and partnership we take on.
            </motion.p>
        ...
        <StorySection 
           title="Our mission"
           content={`At Zira Childcare Foundation, we believe that every child’s story deserves to be told. Our mission is to empower children with special needs and their families across Africa by providing access to the tools, resources, and support they need to thrive. We are building a community where parents, caregivers, and children are not just seen—but celebrated—and where challenges are met with guidance, understanding, and hope. 
